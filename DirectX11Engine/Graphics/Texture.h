...
public:
	...
	Texture(ID3D11Device *device, const Color &color, UINT height, UINT width, aiTextureType type);
	Texture(ID3D11Device *device, const std::string &texturePath, aiTextureType type);
...
private:
	...
	void InitializeColorTexture(ID3D11Device *device, const Color *colorData, UINT height, UINT width, aiTextureType type);
